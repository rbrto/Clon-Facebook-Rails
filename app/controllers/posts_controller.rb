class PostsController < ApplicationController
  ...
  def index
    ...
    # envia la variable @post a el form_for del partial shared/_post_form.html para crear un post
    @post = current_user.posts.build

    # envia a el partial posts/_post.html todos los posts para mostrar uno por uno en una lista <li>
    # current_user hace referencia al modelo user timeline es un query scope con una query 
