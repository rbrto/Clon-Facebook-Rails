...
=begin
  usuario tiene muchos amigos activos (relacion n:m ) ocupo tabla Frienships como pivote
...
=begin
 usuario tiene muchos amigos pasivos (relacion n:m ) ocupo tabla Frienships como pivote igual que arriba la llave foranea del friended_id para mi usuario 2 usando la misma tabla, en este caso un modelo Friendship puede pertenecer a dos usuarios distintos usando el mismo modelo User pero especificando en las llaves foraneas friender_id y friended_id
=end
...
=begin
  relaciona usuarios con active_friends y passive_friend  a traves de las pivotes active_friendships de arriba especificando con source el nombre que ocupare para las tablas , source es como classname pero para las through que se crean
...
=end
  ...
  # retorna los amigos activos y pasivos
  def friends
